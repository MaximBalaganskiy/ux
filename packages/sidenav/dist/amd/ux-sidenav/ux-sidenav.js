define(["require", "exports", "tslib", "aurelia-framework", "../ux-sidenav-drawer/ux-sidenav-drawer", "@aurelia-ux/core", "../ux-default-sidenav-configuration"], function (require, exports, tslib_1, aurelia_framework_1, ux_sidenav_drawer_1, core_1, ux_default_sidenav_configuration_1) {
    "use strict";
    ...
    var UxSidenav = /** @class */ (function () {
        ...
        UxSidenav.prototype.modalBreakpointChanged = function () {
            var _a;
            this._modalBreakpoint = (_a = core_1.normalizeNumberAttribute(this.modalBreakpoint), (_a !== null && _a !== void 0 ? _a : 0));
        };
