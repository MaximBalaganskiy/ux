System.register(["tslib", "./interfaces", "aurelia-framework", "./ux-positioning.css"], function (exports_1, context_1) {
    "use strict";
    var tslib_1, interfaces_1, aurelia_framework_1, flip, UxPositioning;
        ...
        execute: function () {
            ...
            UxPositioning = /** @class */ (function () {
                function UxPositioning(configuration, taskQueue, anchor, element, options) {
                    ...
                    var settings = tslib_1.__assign({}, configuration, options);
                    this.anchor = anchor;
            ...
            exports_1("UxPositioning", UxPositioning);
        }
    };
});
