...
var UxLookup = /** @class */ (function () {
    ...
    UxLookup.prototype.attached = function () {
        var _this = this;
        var _a;
        this.inputElement = (_a = this.element.parentElement) === null || _a === void 0 ? void 0 : _a.querySelector('ux-input');
        if (this.inputElement) {
            inputEvents.map(function (x) { return _this.inputElement.addEventListener(x, _this); });
        }
        lookupEvents.map(function (x) { return _this.element.addEventListener(x, _this); });
        this.valueChanged();
    };
    UxLookup.prototype.detached = function () {
        var _this = this;
        if (this.inputElement) {
            inputEvents.map(function (x) { return _this.inputElement.removeEventListener(x, _this); });
        }
        lookupEvents.map(function (x) { return _this.element.removeEventListener(x, _this); });
    };
    UxLookup.prototype.open = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.updateAnchor();
                windowEvents.map(function (x) { return window.addEventListener(x, _this, true); });
    ...
    UxLookup.prototype.updateAnchor = function () {
        ...
        var inputDistance = parseInt((_a = style.getPropertyValue('--aurelia-ux--lookup-input-distance'), (_a !== null && _a !== void 0 ? _a : UxLookupTheme.DEFAULT_INPUT_DISTANCE.toString())));
        var windowEdgeDistance = parseInt((_b = style.getPropertyValue('--aurelia-ux--lookup-window-edge-distance'), (_b !== null && _b !== void 0 ? _b : UxLookupTheme.DEFAULT_WINDOW_EDGE_DISTANCE.toString())));
        var bottomHeightThreshold = parseInt((_c = style.getPropertyValue('--aurelia-ux--lookup-bottom-height-threshold'), (_c !== null && _c !== void 0 ? _c : UxLookupTheme.DEFAULT_BOTTOM_HEIGHT_THRESHOLD.toString())));
            ...
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        ...
                        this.debouncePromise = new DiscardablePromise(new Promise(function (r) { var _a; return setTimeout(function () { return r(); }, (_a = _this.debounceNumber, (_a !== null && _a !== void 0 ? _a : 0))); }));
                        _f.label = 1;
                    case 1:
                        _f.trys.push([1, 3, , 4]);
