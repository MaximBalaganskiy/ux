...
let UxLookup = UxLookup_1 = class UxLookup {
    ...
    updateAnchor() {
        ...
        const inputDistance = parseInt((_a = style.getPropertyValue('--aurelia-ux--lookup-input-distance'), (_a !== null && _a !== void 0 ? _a : UxLookupTheme.DEFAULT_INPUT_DISTANCE.toString())));
        const windowEdgeDistance = parseInt((_b = style.getPropertyValue('--aurelia-ux--lookup-window-edge-distance'), (_b !== null && _b !== void 0 ? _b : UxLookupTheme.DEFAULT_WINDOW_EDGE_DISTANCE.toString())));
        const bottomHeightThreshold = parseInt((_c = style.getPropertyValue('--aurelia-ux--lookup-bottom-height-threshold'), (_c !== null && _c !== void 0 ? _c : UxLookupTheme.DEFAULT_BOTTOM_HEIGHT_THRESHOLD.toString())));
    ...
    filterChanged() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.debouncePromise = new DiscardablePromise(new Promise(r => { var _a; return setTimeout(() => r(), (_a = this.debounceNumber, (_a !== null && _a !== void 0 ? _a : 0))); }));
            try {
